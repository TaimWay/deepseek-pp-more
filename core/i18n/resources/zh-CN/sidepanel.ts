export const sidepanel = {
  ...
  settings: {
    ...
    askDeepSeekDescription: '配置“问问 DeepSeek”划词提问、全局快捷问答及与“DeepSeek 小鲸鱼”伴侣的深度联动。',
    apiDescription: '侧边栏对话、多模态分析所需的 API Key 与请求地址。',
    openApiDescription: '管理对外开放的 OpenAI 兼容 API、密钥与本地中转服务。',
    ...
    externalApiSection: 'OpenAI 格式对外开放接口',
    externalApiDescription: '通过 ext/api-external-relay 外部中转程序，对外提供标准 OpenAI 兼容的 API 接口。',
    openApiServiceControl: '服务控制与连接状态',
    openApiServiceControlDesc: '监控并控制 ext/api-external-relay 本地中转程序与 WebSocket 连接状态。',
    openApiConfigSection: '运行参数配置',
    openApiConfigDesc: '配置监听端口、WebSocket 桥接地址与默认执行后端。',
    relayPort: 'HTTP 服务端口',
    relayProcessStatus: '中转进程状态',
    running: '运行中',
    stopped: '未运行',
    startServer: '启动中转服务',
    stopServer: '停止中转服务',
    startRelaySuccess: 'Relay 服务进程已启动',
    startRelayFailed: '启动 Relay 失败，请检查 Native Host 或手动运行',
    stopRelaySuccess: 'Relay 服务进程已停止',
    stopRelayFailed: '停止 Relay 失败',
    standaloneModeNotice: '独立守护进程模式（未安装 Native Host，请在终端手动运行）',
    nativeHostConnectedDesc: 'Native Host 已连接，已启用全自动静默守护与一键启停。',
    nativeHostMissingDesc: '未检测到 Native Host，运行以下命令一次性注册当前扩展 ID 即可实现全自动拉起与静默守护：',
    apiKeyManagementTitle: 'API 密钥管理',
    apiKeyManagementDesc: '管理外部客户端调用所需的 Bearer API Key，支持多密钥独立启停与调用统计。',
    managedKeysList: '已授权 API 密钥',
    createApiKey: '创建 API 密钥',
    keyNameLabel: '密钥备注 / 名称',
    customKeyOptional: '自定义密钥（可选）',
    noApiKeysYet: '暂无 API 密钥，点击上方按钮创建第一枚密钥',
    copyFullKey: '复制完整密钥',
    copy: '复制',
    copied: '已复制',
    cancel: '取消',
    ...
    usageCount: '调用次数',
    lastUsed: '最后调用',
    codeExampleSection: '客户端调用示例',
    codeExampleDesc: '可直接复制并在外部工具（如 Cursor、Cherry Studio、OpenWebUI、脚本等）中使用。',
    reconnecting: '重连中...',
    externalApiConnected: 'Relay 已连接',
    externalApiDisconnected: 'Relay 未连接',
    enableExternalApi: '启用对外 API 桥接',
    enableExternalApiDescription: '连接本地 Relay 服务并处理外部 OpenAI 格式的 Chat Completion 对话请求。',
    autoStartRelay: '自动拉起 Relay 守护进程',
    autoStartRelayDesc: '开启后，扩展在后台连接或唤醒时将通过 Native Host 自动静默启动 Relay 服务，无需手动在终端执行命令。',
    relayWsUrl: 'Relay WebSocket 地址',
    relayHost: 'Relay 监听地址',
    relayHostLocal: '127.0.0.1 (仅本机访问)',
    relayHostAll: '0.0.0.0 (开放所有网络接口 / 局域网访问)',
    enableTools: '允许调用扩展 Agent 工具 (Skill / MCP / 联网搜索)',
    enableToolsDesc: '开启后，外部程序可通过 API 调用扩展中注册的 MCP 工具、网页搜索与技能并自动闭环执行。',
    enableMultimodal: '允许外部多模态与图片上传',
    enableMultimodalDesc: '开启后，外部程序可通过 /v1/chat/completions 上传图片并由 DeepSeek 视图模型解析。',
    injectSystemInfo: '自动注入系统时间与环境信息',
    injectSystemInfoDesc: '自动在请求前置注入当前本地时间、模型名称与环境能力元数据。',
    enableExternalMemory: '允许注入长期记忆',
    enableExternalMemoryDesc: '若开启且存在与提问强相关的长期记忆，自动提取注入到对话提示词中。',
    apiKeyConfigModal: '密钥详细配置',
    apiKeyMode: '运行模式',
    apiKeyModeFullAgent: '全功能 Agent（自动执行扩展工具、MCP、技能）',
    apiKeyModeProxyOnly: '纯代理转发（仅中转模型对话，不执行扩展工具）',
    apiKeyOverrideModel: '覆盖/专属模型',
    apiKeyInheritGlobal: '继承全局默认',
    apiKeyBackend: '专属后端',
    apiKeyPerKeyConfig: '配置',
    apiKeyAllowAgentTools: '允许扩展 Agent 工具',
    apiKeyAllowMultimodal: '允许多模态图片',
    apiKeyInjectSystemInfo: '注入系统时间与元数据',
    apiKeyEnableMemory: '注入长期记忆',
    externalApiKey: 'Relay 访问密钥 (API Key)',
    externalApiKeyPlaceholder: '可选，保护本地 API 访问的安全密钥',
    externalApiBackend: '优先执行后端',
    backendAuto: '自动（已配置官方 API Key 时优先，否则使用网页端）',
    backendWeb: 'DeepSeek 网页端会话',
    backendOfficialApi: 'DeepSeek 官方 API',
    externalApiDefaultModel: '默认模型',
    customModel: '自定义模型名称...',
    apiKeyExportNotice: '环境变量配置（在终端中执行或配置至客户端）：',
    copyExportCmd: '复制 export 命令',
    externalApiSaved: '对外 API 桥接配置已保存',
    reconnect: '重新连接',
    reconnected: '已重新连接 Relay 服务',
    reconnectFailed: '重新连接 Relay 服务失败',
    curlExample: 'cURL 调用示例',
    ...
    askDeepSeekTitle: '问问 DeepSeek',
    askDeepSeekSection: '问问 DeepSeek 快捷问答',
    askDeepSeekSectionDesc: '随时在任意网页或 DeepSeek 页面发起提问，支持划选文本快捷操作与全局呼出。',
    askDeepSeekEnable: '启用“问问 DeepSeek”功能',
    askDeepSeekEnableDesc: '开启后支持全局快捷呼出问答、划词提问与小鲸鱼交互。',
    quickSelectionSection: '划词快捷提问',
    quickSelectionSectionDesc: '在网页中选中文本时显示快捷操作条，一键提问或处理选中的内容。',
    quickSelectionEnable: '划选文本快捷提问',
    quickSelectionEnableDesc: '选中文本后自动浮现 DeepSeek 快捷工具条',
    defaultActionLabel: '默认快捷动作',
    defaultActionFreeAsk: '自由提问 (输入自定义问题)',
    defaultActionExplain: '详细解释 (深入解读选中文本)',
    defaultActionSummarize: '核心总结 (提炼要点与摘要)',
    defaultActionTranslate: '中英互译 (翻译为另一门语言)',
    defaultModelLabel: '快捷提问触发模型',
    triggerModeLabel: '默认唤起界面',
    triggerModeFloating: '悬浮对话窗 (页面浮层)',
    triggerModeSidepanel: '侧边栏面板 (浏览器侧栏)',
    whalePetIntegrationSection: '“DeepSeek 小鲸鱼”伴侣联动',
    whalePetIntegrationDesc: 'DeepSeek 小鲸鱼不仅是页面桌宠伴侣，更是你的快速问答助手。小鲸鱼会根据思考、流式输出、工具调用等状态展示丰富的情绪与互动气泡。',
    whalePetClickAction: '点击小鲸鱼动作',
    whalePetClickActionDesc: '点击小鲸鱼伴侣时直接开启问答对话',
    whalePetBubbleFeedback: '状态语音气泡',
    whalePetBubbleFeedbackDesc: '思考、搜索和执行工具时显示实时气泡状态反馈',
    whalePetMotionToggle: '伴侣动态漂浮动画',
    whalePetMotionToggleDesc: '开启小鲸鱼活泼自然的呼吸与漂浮动效',
    customizeAppearanceInAppearanceTab: '前往“外观”选项自定义小鲸鱼造型、位置、尺寸与动效 →',
    debugModeTitle: '全局 DEBUG 调试模式',
    debugModeDesc: '开启后输出全量详细调试日志，捕获并展示所有异常堆栈信息。',
    interceptRequestsTitle: '拦截并修改外部请求',
    interceptRequestsDesc: '开启后所有外部 API 请求将在此暂停，由开发者检查或修改 Prompt / 参数后再放行。',
    interceptionQueueTitle: '待审核请求队列',
    noPendingInterceptions: '当前没有被拦截的待审核请求',
    approveAndContinue: '放行并发送',
    rejectRequest: '丢弃请求',
    modifyAndApprove: '修改并继续',
    autoRefreshLogs: '自动刷新日志',
    manualRefresh: '手动刷新',
    refreshEvery1s: '每 1 秒',
    refreshEvery2s: '每 2 秒',
    refreshEvery5s: '每 5 秒',
    apiPlaygroundTitle: 'API 请求调试与生成 (Playground)',
    apiPlaygroundDesc: '选择模型、工具与参数，一键生成 cURL 命令或直接向服务发送请求测试。',
    generateCurl: '生成 cURL',
    sendRequestNow: '直接发送请求',
    requestResultTitle: '调试响应结果',
    granularToolsTitle: 'Agent Call 颗粒度工具配置',
    granularToolsDesc: '精确控制外部 API 允许模型调用的具体工具种类与执行上限。',
    maxToolStepsLabel: '单次请求最大工具循环步数',
    toolTimeoutLabel: '单次工具调用超时时间 (秒)',
    askDeepSeekSelection: '问问 DeepSeek：选中文本',
    askDeepSeekPage: '问问 DeepSeek：解释此网页',
    explainPageChip: '🌐 解释该网页',
    summarizePageChip: '📝 总结核心要点',
    askAboutPageChip: '❓ 针对网页提问',
    translateSelectionChip: '🌐 翻译此选段',
    freeChatChip: '💬 自由对话',
    debugModeEnabled: 'DEBUG 模式已启用',
    debugModeDisabled: 'DEBUG 模式已关闭',
    interceptEnabled: '外部请求拦截已启用',
    interceptDisabled: '外部请求拦截已关闭',
    curlCopied: 'cURL 命令已复制到剪贴板',
    explainPagePrompt: '请详细阅读并解释当前网页的核心内容、主旨与关键信息。',
    summarizePagePrompt: '请提炼当前网页的核心要点与关键结论，以清晰的列表格式输出。',
    askPagePrompt: '我想了解关于当前网页的以下内容：',
    messagesCount: '{{count}} 条消息',
    diagnosticLogsTitle: '运行诊断日志 ({{count}})',
    allModules: '全部模块',
    allLevels: '全部级别',
    noLogsMatch: '暂无匹配的日志记录',
    ...
    openOptionsPage: '独立设置页',
    openOptionsPageTitle: '在独立浏览器标签页中打开完整设置',
    githubRepo: 'GitHub 开源主页',
    devOptionsTitle: '开发者选项与实时日志 (Developer Options)',
    collapse: '收起',
    expand: '展开',
    relayProbeTitle: '中继网络连通性探测 (Relay Network Probe)',
    startTest: '开始测试',
    probing: '探测中...',
    probeSuccess: '✓ 连接正常',
    probeFailed: '✗ 连接失败',
    probeLatency: '中继正常 (延迟 {ms}ms)',
    probeError: '中继探测失败: {error}',
    availableModels: '可用模型: {models}',
    externalSessionsTitle: '外部 API 活动会话 ({count})',
    clearAllSessions: '清空全部会话',
    noActiveSessions: '暂无外部客户端活动会话',
    turnLabel: '轮次: {count}',
    modelLabel: '模型: {model}',
    tokensLabel: 'Token: {count}',
    agentCallsLabel: 'Agent 调用: {count}',
    agentToolsLabel: '工具: {tools}',
    firstPromptLabel: '首条: {text}',
    attachmentsLabel: '附件: {count}',
    deleteSession: '删除',
    sessionDeleted: '会话已删除',
    allSessionsCleared: '已清空所有外部会话',
    logsTitle: '实时诊断日志',
    logCount: '{filtered} / {total} 条',
    refreshLogs: '刷新日志',
    copyLogs: '复制',
    exportJson: '导出 JSON',
    clearLogs: '清空',
    ...
    logsExported: '日志已导出为 JSON 文件',
    copyFailed: '复制失败',
    searchLogsPlaceholder: '搜索日志关键字...',
    levelLabel: '级别:',
    moduleLabel: '模块:',
    allLabel: '全部',
    noMatchingLogs: '没有匹配的诊断日志',
    apiKeyCreated: 'API Key 创建成功',
    apiKeyCopied: 'API Key 已复制到剪贴板',
    codeSnippetCopied: '代码示例已复制到剪贴板',
  },
  promptControls: {
    title: '提示词控制',
    memory: '记忆注入',
  ...
  chatPage: {
    ...
    inputPlaceholder: '给 DeepSeek++ More 发送消息',
    send: '发送',
    sendFailed: '发送失败',
    uploadImage: '上传图片',
