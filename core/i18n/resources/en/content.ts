export const content = {
  ...
  projectSidebar: {
    ...
    externalApiTitle: 'External API Sessions',
    batchManage: '☑ Batch Manage',
    exitBatchManage: '✕ Exit',
    batchConfirmDelete: 'Delete selected {count} conversations?',
    batchConfirmSub: 'This will permanently remove conversation records on DeepSeek.',
    ...
    selectExternal: '⚡ Select External ({count})',
    expandExternalApi: 'Expand External API Sessions',
    collapseExternalApi: 'Collapse External API Sessions',
    noExternalSessions: 'No external sessions yet (auto-grouped on call)',
    deleteExternalSession: 'Delete this external session',
    testBadge: 'Test',
    age: {
      justNow: 'Just now',
