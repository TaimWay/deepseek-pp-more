...
const CUTOVER_LEDGER_SECTIONS = [
  ...
  ['R4.3 / #362 — DeepSeek, chat, multimodal, and export (17)', 17],
  ['R4.4 / #363 — Sync, automation, usage, scenario, and lifecycle closure (22)', 22],
] as const;
